<div class="wrapper">
    <section class="container">
        <div class="content">
            <div class="content-title">
                <div class="title" style="word-break: break-all;">Search: <? echo $keyword ?></div>
            </div>
                            ...
                            <? } ?>
                                ...
                                <div class="card-description">
                                    <div class="card-description-content">
                                        ...
                                        ?>
                                            <div class="card-description-type"><? echo $sound ?></div>
                                        <?
                                            } else {
                                        ?>
    ...
    <section class="container">
        <div class="web-description">
            ...
            ของภาษาอยู่ ณ ขณะนี้ ทางเว็บเราได้จัดทำ ตัวเลือกสำหรับการเลือกภาษา ไว้ให้แล้ว มีทั้ง SoundTrack , Thai และภาษาหลักของทางต้นค่ายอนิเมะ และในส่วน
            ...
            ทางเว็บอนิเมะของเรา ได้ทำการรวบรวมไว้ทั้ง อนิเมะเก่า และ อนิเมะใหม่ ไว้ให้ท่านด้วยเพื่อที่จะได้ครบทุกอรรถรส ในการรับ ชมภาพยนตร์ ทั้งนี้ หากเกิดปัญหาในเรื่อง
